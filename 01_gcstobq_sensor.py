...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='bkt-try-global-data',  # Replace with your bucket name
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='key-utility-455901-i5.staging_dataset',  # Replace with your project, dataset, and table name
        source_format='CSV', 
